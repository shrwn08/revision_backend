...
//   const user = await User.findOne(); // Replace with an existing user
//   console.log("Access Token:", user.generateAccessToken());
//   console.log("Refresh Token:", user.generateRefreshToken());
// };
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    if (incommingRefreshToken !== user?.refreshToken) {
      throw new ApiError(401, "refresh thoken is expired or used");
    }
